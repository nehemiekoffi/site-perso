<template>
  <div class="w-full max-w-screen-3xl mx-auto">
    <!-- NAVBAR -->
    <div class="sticky top-0 w-full h-16 bg-white border border-b border-b z-50 shadow shadow-gray-500/10">
      <div class="w-11/12 xl:w-10/12 max-w-8xl h-full mx-auto flex items-center justify-between">
        <div class="">
          <h1 class="text-xl text-black font-black">Recipe AI</h1>
        </div>
        <div class="block lg:hidden">
          <button class="flex items-center justify-center text-3xl" @click="isSidebarOpen = true">
            <UIcon name="i-mdi-menu" />
          </button>
        </div>
        <div class="hidden lg:flex items-center gap-x-6">
          <button class="text-black text-md font-semibold">Create meal plan</button>
          <button class="text-black text-md font-semibold">Calorie calculator</button>
          <button class="flex items-center gap-x-1 text-white text-sm font-bold bg-green-500 px-3 py-2 rounded-md"
    ...
    <UModal v-model="isModalOpen">
      <div class="w-full mx-auto h-fit pb-5 bg-white">
        ...
        <div class="flex flex-col-reverse sm:flex-row items-start justify-between h-full">
          <!-- Free plan -->
          <div class="w-full sm:w-1/2 h-full sm:border-r p-3">
            ...
            <button class="w-full h-10 font-semibold text-gray-600 text-sm rounded-md bg-gray-200 mt-3">
              You current plan
            </button>
            <div class="mt-5">
          ...
          <div class="w-full sm:w-1/2 h-full p-3">
            ...
            <button class="w-full h-10 font-semibold text-white text-sm rounded-md bg-green-500 mt-3">
              Upgrade plan
            </button>
            <div class="mt-5">
              <div class="flex items-center gap-x-2">
      ...
      <div class="min-w-[200px] w-full min-h-screen border-r px-6">
        ...
        <div class="mt-5 w-full">
          ...
          <div class="mt-2 account-nav">
            <UVerticalNavigation :links="links2" :ui="{
              wrapper:
                'border-l border-gray-200 dark:border-gray-800 space-y-2',
              base: 'group block border-l border-l-2 text-gray-500 -ml-px lg:leading-6',
              padding: 'pl-2',
