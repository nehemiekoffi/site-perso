<template>
  <PortfolioLayout>
    <div class="bg-[#0A0A0A] w-full min-h-screen pb-40">
      <div
        class="w-11/12 sm:w-9/12 md:w-10/12 lg:w-8/12 max-w-5xl mx-auto pt-16"
      >
        <h1
        ...
        <div
          class="flex flex-col md:flex-row items-start justify-between gap-x-5 mt-20"
        >
          ...
          <div class="mt-6 sm:mt-10 flex items-center">
            ...
            <div class="relative flex overflow-x-hidden">
              <div class="marq py-12 animate-marquee whitespace-nowrap">
                ...
                <span class="text-xl text-stone-400 mx-4"
              ...
              <div
                class="marq absolute top-0 py-12 animate-marquee2 whitespace-nowrap"
              >
                <span class="text-xl text-stone-400 mx-4">Web Design</span>
                <span class="text-xl text-stone-400 mx-4"
                  >User Interface Design</span
        ...
        <div
          class="w-full h-fit rounded-3xl bg-[#0f0f0f] border border-stone-800 mt-20 px-5 py-8"
        >
          <h4
            class="text-xl md:text-2xl text-stone-500 text-center font-semibold"
          >
            Tools & Sofware I use
          </h4>
          ...
          <div
            class="w-full md:w-10/12 lg:w-8/12 mx-auto overflow-x-scroll hide-scroll-bar mt-8"
          >
              ...
              <div class="inline-block px-1 sm:px-3">
                ...
                >
                  <img
                    ...
                    alt="artboard"
                    class="w-5 mx-auto object-cover"
                  />
                </div>
              </div>
              <div class="inline-block px-1 sm:px-3">
        ...
        <div
          class="flex flex-col md:flex-row md:items-start justify-center mt-28"
        >
          ...
          <div class="w-full md:w-1/2 mt-16 md:mt-0">
            <div class="">
              <p
                class="text-lg text-stone-500 font-semibold flex items-center gap-x-1"
              >
        ...
        <div class="mt-36 pb-16">
          ...
          <p
            class="sm:w-[500px] mx-auto text-stone-500 text-center text-lg font-medium mt-10"
          >
