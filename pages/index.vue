    ...
    <div class="bg-[#0A0A0A] w-full min-h-screen pb-40">
      ...
      <div class="w-11/12 sm:w-[600px] mx-auto pt-16 px-2 sm:px-10 md:px-0">
        ...
        <div class="mt-10 flex items-start justify-between">
          ...
          <div class="w-fit">
            <p class="text-stone-400 font-normal">
              This marks the start of my adventure with Skan Technologie as a web application developer, using ReactJS,
              Vuejs and Wordpress. I participate in the development of new customer applications, but also in the
              realization of internal company projects.
            </p>
          </div>
        </div>
        ...
        <div class="mt-5 flex items-start justify-between">
          ...
          <div class="w-fit">
            <p class="text-stone-400 font-normal">
              Joined SITC (Southern IT Consulting) as a full-stack developer, helping to develop existing projects as well
              as participating in the realization and delivery of customer projects. The main technologies used were
              Angulare, Nestjs and MySQL.
            </p>
          </div>
        </div>
