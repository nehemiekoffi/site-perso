  ...
  <PortfolioLayout>
    <div class="bg-[#0A0A0A] w-full min-h-screen pb-40">
      <div class="w-11/12 sm:w-9/12 md:w-7/12 mx-auto pt-16">
        <div
          class="relative w-44 h-56 mx-auto h-24 rounded-xl border border-stone-600 p-1"
        >
          <img
        ...
        <h1
          class="text-4xl sm:text-5xl text-white text-center font-extrabold mt-10"
        >
          Adams Aimé-Désiré
        </h1>
        <h1
          class="text-lg sm:text-xl text-white text-center font-semibold mt-2"
        >
          Javascript developer
        </h1>
        <div class="flex items-center justify-center gap-x-2 mt-4">
          <div
            class="w-3 h-3 rounded-full border border-green-500 flex items-center justify-center"
          >
            <div class="w-1.5 h-1.5 rounded-full bg-green-500"></div>
          </div>
          <p class="text-sm text-zinc-400 text-center font-normal">
      ...
      <div
        class="relative w-11/12 sm:w-[600px] mx-auto pt-24 px-2 sm:px-10 md:px-0"
      >
      ...
      <div class="w-11/12 sm:w-[600px] mx-auto pt-24 px-2 sm:px-10 md:px-0">
        <h2 class="text-3xl text-center text-white font-semibold">
          Got a question or project idea? Contact me and let's discuss how we
          can work together to bring your ideas to life.
        </h2>

        <div
          class="relative mt-14 w-full flex flex-col items-center justify-center gap-y-2"
        >
          <a href="mailto:ad.aimedesire@gmail.com">
            <button
              class="bg-indigo-500 w-80 h-12 rounded-full text-lg sm:text-xl text-white font-bold"
            >
