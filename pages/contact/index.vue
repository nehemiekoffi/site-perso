<template>
  <PortfolioLayout>
    <div class="bg-[#0A0A0A] w-full min-h-screen flex items-center justify-center pb-20">
      <div class="relative w-11/12 sm:w-10/12 md:w-9/12 mx-auto max-w-5xl pt-20">
        <h1 class="text-center text-4xl md:text-5xl text-white font-bold">
          Let's start the journey together
        </h1>
        <img src="~/assets/images/art_2.png" alt="artboard" class="absolute w-8 -rotate-35" />
        ...
        <div
          ...
          <a href="mailto:nehemiekoffi@gmail.com">
            <button class="bg-[#282828] w-72 md:w-62 h-12 rounded-full text-white text-center text-sm font-semibold">
              nehemiekoffi@gmail.com
            </button>
          </a>
          <a href="https://wa.me/+2250556987000" target="_blank" rel="noopener noreferrer">
            <button class="bg-indigo-500 w-72 md:w-62 h-12 rounded-full text-white text-center text-sm font-semibold">
              Send a message
            </button>
          </a>
        </div>
